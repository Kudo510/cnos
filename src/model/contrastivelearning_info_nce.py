...
def prepare_dataset(template_paths, template_poses_path, all_pos_proposals, all_neg_proposals):
    ...
    train_dataset = PairedDataset(train_set, transform=train_transform)
    val_dataset = PairedDataset(val_set, transform=None) # No transform for val set
    test_dataset = PairedDataset(test_set, transform=None)
