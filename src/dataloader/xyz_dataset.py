...
if __name__ == "__main__":
    ...
    obj_mesh_path = "datasets/bop23_challenge/datasets/hudiebanjin/models/obj_000001.ply"
    dataset_path = "datasets/bop23_challenge/datasets/hudiebanjin/scene000002"
    main()
